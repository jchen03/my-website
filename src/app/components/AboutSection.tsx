...
const AboutSection = () => {
  return (
    <section id="about" className="h-3/4 bg-black-100 p-8 mb-10">
      ...
      <div className="w-full md:w-1/2 mb-4 md:mb-0 mr-4 pl-40">
        <Image src={selfie} alt="Ignore the messy hair"className="w-48 h-auto rounded-lg" />
      </div>

        <div className="w-1/2 pl-8">
          <div className="text-[100px] font-bold ${exo2.className} mb-4">Hi, I&apos;m Jerry</div>
          <div className="text-[20px] text-gray-800">
          I am a computer science student studying at the University of Toronto with a strong passion for DevOps and software development, 
          with a particular interest in cloud computing. I have experience working with AWS, Azure, and GCP, and I am always looking to learn more about the latest technologies. <br/>
